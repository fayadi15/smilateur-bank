...
KEY = "BIATIMMO"
URL = "https://www.biat.tn/biat/Fr/biatimmo_82_335"
...
def fill(page, profile: dict):
    ...
    # type taux: défaut variable (value="2")
    common.check_radio(page, 'input[name="taux_type"][value="2"]')
    profile["biat_taux_type_used"] = 2
...
def submit_and_wait(page):
    page.wait_for_selector("input#bt_crediDirectImmo_simulateur", state="visible", timeout=20000)
    try:
        with page.expect_navigation(wait_until="networkidle", timeout=15000):
            page.click("input#bt_crediDirectImmo_simulateur")
    except Exception:
        page.click("input#bt_crediDirectImmo_simulateur")
