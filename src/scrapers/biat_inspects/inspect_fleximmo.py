...
KEY = "FLEXIMMO"
URL = "https://www.biat.tn/biat/Fr/fleximmo_87_399"
...
def submit_and_wait(page):
    page.wait_for_selector("input#bt_crediFlexImm_simulateur", state="visible", timeout=20000)
    try:
        with page.expect_navigation(wait_until="networkidle", timeout=15000):
            page.click("input#bt_crediFlexImm_simulateur")
    except Exception:
        page.click("input#bt_crediFlexImm_simulateur")
