...
KEY = "CREDIFOYER"
URL = "https://www.biat.tn/biat/Fr/credifoyer_81_334"
...
def submit_and_wait(page):
    page.wait_for_selector("a#bt_credifoyer_simulateur", state="visible", timeout=20000)
    page.click("a#bt_credifoyer_simulateur")
