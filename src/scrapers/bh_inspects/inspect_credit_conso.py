...
KEY = "CREDIT_CONSO"
URL = "https://www.bhbank.tn/cr%C3%A9dit-consommation"
...
def fill(page, profile: dict):
    ...
    salaire = float(profile.get("salaire_net", 1800) or 1800)

    duree_ans = common.months_to_years(profile.get("duree_mois", 24), min_years=1, max_years=3)
