...
class Inspect:
    ...
    def fill(self, page, profile: Dict[str, Any]):
        ...
        # car financing often requires higher own contribution; default 30%
        apport = (
        ...
        if apport is None:
            apport = round(float(montant) * 0.3, 3)
...
SAYARAT_NEUVE_5_8CH = Inspect(
    KEY="SAYARAT_NEUVE_5_8CH",
    URL="https://www.albaraka.com.tn/fr/simulateur/sayarat-al-baraka-neuve-5-8ch",
    TYPE_SLUG="sayarat-al-baraka-neuve-5-8ch",
)
