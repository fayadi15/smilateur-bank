...
class Inspect:
    ...
    def fill(self, page, profile: Dict[str, Any]):
        # Ensure correct financing type selected
        ...
        if apport is None:
            # default 20%
            apport = round(float(montant) * 0.2, 3)
        ...
        duree_mois = int(profile.get("duree_mois") or 240)
...
DAR_AL_BARAKA = Inspect(
    KEY="DAR_AL_BARAKA",
    URL="https://www.albaraka.com.tn/fr/simulateur/dar-al-baraka",
    TYPE_SLUG="dar-al-baraka",
)
